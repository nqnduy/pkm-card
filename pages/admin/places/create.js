	...
	return (
		<LayoutPage header={header} user={user}>
			<Section borderBottom={true} style={{ padding: "2rem 0" }}>
				...
				<HorizontalList itemSize={ListItemSize.STRETCH}>
					<ListItem style={{ marginRight: "1rem" }}>
						<Input ref={(el) => (formInputRef.current.phone = el)} label="Phone" placeholder="số điện thoại" maxLength="255" />
					</ListItem>
					<ListItem style={{ marginRight: "1rem" }}>
						<Input
				...
				<HorizontalList itemSize={ListItemSize.STRETCH}>
					<ListItem style={{ marginRight: "1rem" }}>
						<Input ref={(el) => (formInputRef.current.lat = el)} label="Latitude" placeholder="Vĩ độ trên map" maxLength="255" />
					</ListItem>
					<ListItem style={{ marginRight: "1rem" }}>
						<Input ref={(el) => (formInputRef.current.lng = el)} label="Longitude" placeholder="Kinh độ trên map" maxLength="255" />
					</ListItem>
				</HorizontalList>
