			...
			<Card>
				...
				<CardBody>
					<Nav>
						...
						<DashkitButton type={ButtonType.TRANSPARENT} onClick={() => setActiveIndex(1)} active={activeIndex == 1}>
							Link
						</DashkitButton>
						<DashkitButton type={ButtonType.TRANSPARENT} onClick={() => setActiveIndex(2)} active={activeIndex == 2}>
							Link
						</DashkitButton>
