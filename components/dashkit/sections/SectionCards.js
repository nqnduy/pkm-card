		...
		<Section id="cards" padding="30px">
			...
			<Card shadow={true}>
				<CardBody>
					...
					<BlockSplitter />
					<p>
						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis non dolore est fuga nobis ipsum illum eligendi nemo iure
						repellat, soluta, optio minus ut reiciendis voluptates enim impedit veritatis officiis.
					</p>
					<BlockSplitter />
  ...
  <CardBody>
    ...
    <DashkitButton>Go somewhere</DashkitButton>
			...
			<Card shadow={true}>
				...
				<CardBody>
					Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis fugiat dolorem, expedita rem. Quis natus officiis
					asperiores rem ipsum, dolore cumque voluptatum iste vel alias, recusandae culpa hic pariatur quos.
				</CardBody>
				<CardFooter padding="0">
