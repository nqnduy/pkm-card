...
const MemberComponent = (props) => {
	...
	return (
		<HorizontalList itemSize="auto">
			...
			<ListItem style={{ marginRight: "1rem" }}>
				{members ? (
					<InputSelect
						...
						ref={(el) =>
							(props.formInputRef.current[`content_${locale}[${props.indexParentRef}][members][${props.indexRef}][memberId]`] = el)
						}
			...
			<ListItem style={{ marginRight: "1rem" }}>
				<AdminButton size={ButtonSize.SMALL} style={{ margin: "5px", float: "right" }} onClick={() => props.onClick(props.indexRef, false)}>
					+
				</AdminButton>
				<AdminButton
