		...
		<Collapse defaultActiveKey={[`postContent_${props.locale}${props.indexRef}`]}>
			<Panel header="Section 3" key={`postContent_${props.locale}${props.indexRef}`}>
				<ListItem style={{ marginRight: "1rem" }}>
					<InputSelect ref={(el) => (formInputRef.current.section = el)} labelInValue defaultValue={{ value: 3 }}>
					...
					<ListItem style={{ marginRight: "1rem" }}>
						<ContentImage
							...
							imageUrl={
								props.contentImgs[
									`${
										props.content.drimage1
											? getFileNameFromPath(props.content.drimage1)
											: `drimage1_${props.locale}${props.indexRef}`
									}Url`
								] || props.content.drimage1
							}
					...
					<ListItem style={{ marginRight: "1rem" }}>
						<ContentImage
							...
							imageUrl={
								props.contentImgs[
									`${
										props.content.drimage2
											? getFileNameFromPath(props.content.drimage1)
											: `drimage2_${props.locale}${props.indexRef}`
									}Url`
								] || props.content.drimage2
							}
					...
					<ListItem style={{ marginRight: "1rem" }}>
						<ContentImage
							...
							imageUrl={
								props.contentImgs[
									`${
										props.content.drimage3
											? getFileNameFromPath(props.content.drimage3)
											: `drimage3_${props.locale}${props.indexRef}`
									}Url`
								] || props.content.drimage3
							}
					...
					<ListItem style={{ marginRight: "1rem" }}>
						<ContentImage
							...
							imageUrl={
								props.contentImgs[
									`${
										props.content.drimage4
											? getFileNameFromPath(props.content.drimage4)
											: `drimage4_${props.locale}${props.indexRef}`
									}Url`
								] || props.content.drimage4
							}
